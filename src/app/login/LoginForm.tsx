...
export function LoginForm() {
  ...
  const recienCreado = searchParams.get("nuevo") === "1";
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[#f3f8fd] px-4">
      <div className="w-full max-w-md">
        ...
        <div className="rounded-xl bg-white p-8 shadow-sm border border-[#f7941d]/30">
          ...
          {recienCreado ? (
            <div className="mb-4 rounded-lg border border-emerald-200 bg-emerald-50 px-4 py-3 text-sm text-emerald-900">
              Usuario creado. Iniciá sesión con el usuario y contraseña que elegiste.
            </div>
          ) : null}
        ...
        <div className="text-center mt-6 space-y-2 text-xs text-[#213b5c]/60 leading-relaxed">
          <p>
            <Link href="/primer-acceso" className="font-medium text-[#2196F3] hover:underline">
              ¿Primera vez en el sistema? Crear el administrador
            </Link>
          </p>
          <p>
            Si ya entraste antes: más usuarios en Configuración → Usuarios acceso. Perfil abogado: solo casos asignados.
          </p>
        </div>
      </div>
    </div>
