...
export default async function TicketsReclamosComercialesPage() {
  await requireSession();
  const legalType = "Reclamos comerciales";
  ...
  return (
    <TicketsLayout>
      <div className="mx-auto max-w-6xl space-y-6">
        <div>
          <h1 className="text-3xl font-bold text-slate-900">Reclamos comerciales</h1>
