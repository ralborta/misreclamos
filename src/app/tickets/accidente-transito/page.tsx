...
export default async function TicketsAccidenteTransitoPage() {
  await requireSession();
  const legalType = "Accidente de tránsito";
  ...
  return (
    <TicketsLayout>
      <div className="mx-auto max-w-6xl space-y-6">
        <div>
          <h1 className="text-3xl font-bold text-slate-900">Accidente de tránsito</h1>
        ...
        <div className="rounded-xl bg-amber-50 p-6 ring-1 ring-amber-100">
          <div className="text-sm font-medium text-amber-800">Total</div>
